...
macro_rules! __internal_create_nrf_timer_interrupt {
    ($mono_timer:ident, $timer:ident, $timer_token:ident) => {{
        ...
        unsafe extern "C" fn $timer() {
            $crate::nrf::timer::$mono_timer::__tq()
                .on_monotonic_interrupt::<$crate::nrf::timer::$mono_timer>();
        }
...
macro_rules! make_timer {
    ($mono_name:ident, $timer:ident, $overflow:ident, $tq:ident$(, doc: ($($doc:tt)*))?) => {
        ...
        static $tq: TimerQueue<fugit::TimerInstantU64<1_000_000>> = TimerQueue::new();
        ...
        impl $mono_name {
            ...
            #[doc(hidden)]
            pub fn __tq() -> &'static TimerQueue<fugit::TimerInstantU64<1_000_000>> {
                &$tq
            }
